...
>
  <head>
    ...
    <title><?= $application['name'] ?> - Halaman Tidak Ditemukan</title>
  ...
  <body>
    ...
    <script defer src="<?= base_url('template/assets/vendor/libs/jquery/jquery.js') ?>"></script>
    <script defer src="<?= base_url('template/assets/vendor/libs/popper/popper.js') ?>"></script>
    <script defer src="<?= base_url('template/assets/vendor/js/bootstrap.js') ?>"></script>
    <script defer src="<?= base_url('template/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js') ?>"></script>

    <script defer src="<?= base_url('template/assets/vendor/js/menu.js') ?>"></script>
    <!-- endbuild -->

    <!-- Vendors JS -->

    <!-- Main JS -->
    <script defer src="<?= base_url('template/assets/js/main.js') ?>"></script>

    <!-- Page JS -->

    <!-- Place this tag in your head or just before your close body tag. -->
    <script defer async defer src="https://buttons.github.io/buttons.js"></script>
  </body>
</html>
