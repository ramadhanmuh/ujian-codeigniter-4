...
<?= $this->section('page_title') ?>
    Soal - <?= esc($record['id']) ?> - Ubah
<?= $this->endSection() ?>

<?= $this->section('page_content') ?>
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Soal / <?= esc($record['id']) ?> /</span>
            Tambah
        </h4>
                        ...
                        <form class="row" method="post">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    required
                                ><?= old('text') === null ? esc($record['text']) : old('text') ?></textarea>
                            </div>
                            <div class="col-xl-6 mb-3">
                                ...
                                <textarea
                                    ...
                                    rows="2"
                                    required
                                ><?= old('option_a') === null ? esc($record['option_a']) : old('option_a') ?></textarea>
                            </div>
                            <div class="col-xl-6 mb-3">
                                ...
                                <textarea
                                    ...
                                    rows="2"
                                    required
                                ><?= old('option_b') === null ? esc($record['option_b']) : old('option_b') ?></textarea>
                            </div>
                            <div class="col-xl-6 mb-3">
                                ...
                                <textarea
                                    ...
                                    rows="2"
                                    required
                                ><?= old('option_c') === null ? esc($record['option_c']) : old('option_c') ?></textarea>
                            </div>
                            <div class="col-xl-6 mb-3">
                                ...
                                <textarea
                                    ...
                                    rows="2"
                                    required
                                ><?= old('option_d') === null ? esc($record['option_d']) : old('option_d') ?></textarea>
                            </div>
                            <div class="col-xl-6 mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input
                                        ...
                                        name="correct_answer"
                                        value="a"
                                        <?= old('correct_answer') === 'a' ? 'checked' : ($record['correct_answer'] === 'a' ? 'checked' : '') ?>
                                        required
                                    >
                                ...
                                <div class="form-check form-check-inline">
                                    <input
                                        ...
                                        name="correct_answer"
                                        value="b"
                                        <?= old('correct_answer') === 'b' ? 'checked' : ($record['correct_answer'] === 'b' ? 'checked' : '') ?>
                                        required
                                    >
                                ...
                                <div class="form-check form-check-inline">
                                    <input
                                        ...
                                        name="correct_answer"
                                        value="c"
                                        <?= old('correct_answer') === 'c' ? 'checked' : ($record['correct_answer'] === 'c' ? 'checked' : '') ?>
                                        required
                                    >
                                ...
                                <div class="form-check form-check-inline">
                                    <input
                                        ...
                                        name="correct_answer"
                                        value="d"
                                        <?= old('correct_answer') === 'd' ? 'checked' : ($record['correct_answer'] === 'd' ? 'checked' : '') ?>
                                        required
                                    >
